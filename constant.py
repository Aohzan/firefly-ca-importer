...
TRANSFER_SOURCE_TRANSACTION_NAME_FIELD = "transfer-source-transaction-name"
TRANSFER_SOURCE_TRANSACTION_NAME_DEFAULT = "WEB LASTNAME FIRSTNAME"
TRANSFER_DESTINATION_TRANSACTION_NAME_FIELD = "transfer-destination-transaction-name"
TRANSFER_DESTINATION_TRANSACTION_NAME_DEFAULT = "DE LASTNAME FIRSTNAME"
# ----------- FIREFLY ---------- #
